...
kafka_security_options = {
    'kafka.bootstrap.servers': 'rc1a-1im2demdsu72o02i.mdb.yandexcloud.net:9091',
...
vertica_url = 'jdbc:vertica://51.250.75.20:5433/dwh'
...
def load_df_kafka(spark: SparkSession, topic: StringType) -> DataFrame:
...
df = load_df_kafka(spark, topic = 'transaction-service-input')
df = transform(df)
